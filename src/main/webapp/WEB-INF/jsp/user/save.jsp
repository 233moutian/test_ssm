    ...
    <form action="${pageContext.request.contextPath}/user/signup" id="commentForm" method="post">
        <table border="1" width="75%" height="550" bgcolor="#F9F9F9" cellspacing="0" cellpadding="0"
            ...
            <tr>
                ...
                <td>
                    <input type="radio" id="male" name="gender" value="男" <c:if test="${requestScope.user.gender=='男'}">
                        checked="checked"
                    </c:if>/>男
                    <input type="radio" id="female" name="gender" value="女" <c:if test="${requestScope.user.gender=='女'}">
                        checked="checked"
                    </c:if>/>女
                </td>
            </tr>
            <tr>
                ...
                <td colspan="4"><input type="text" name="phonenumber" id="phonenumber" size="30"
                                       value="${requestScope.user.phonenumber}"/></td>
            </tr>
            <tr>
                <td align="right">E-mail：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td colspan="4">
                    <input type="text" id="email" name="email" size="30" value="${requestScope.user.email}"/>
                </td>
            </tr>
            <tr>
