        ...
        <DIV ID="CenterArea">
            ...
            <DIV ID="LoginInfo">
                <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
                    ...
                    <TR>
                        <TD STYLE="padding-left:10px;"><INPUT TYPE="image" SRC="${pageContext.request.contextPath}/resources/images/login/login.gif"/></TD>
                        <TD><a href="${pageContext.request.contextPath}/user/save" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img SRC="${pageContext.request.contextPath}/resources/images/login/sigeup.gif"/></a></TD>
                    </TR>
                </TABLE>
            </DIV>
        </DIV>
